...
export function FounderFitCard({ data, onCompleteProfile, onRegenerate, regenerating, hasFounderProfile, onGenerate, generating }: Props) {
  ...
  if (noFounderData) {
    return (
      <div className="bg-white dark:bg-[#12121A] border-2 border-gray-100 dark:border-white/5 rounded-3xl p-6 relative shadow-sm">
        ...
        <div className="flex flex-col items-center gap-4 py-6 text-center">
          {hasFounderProfile ? (
            <>
              <p className="text-sm text-gray-500 dark:text-[#8B8AA0] leading-relaxed max-w-md">
              ...
              {onRegenerate && (
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#38D5E3] text-[#0A0A0F] text-sm font-bold hover:bg-[#2bc3d1] disabled:opacity-50 transition-colors shadow-sm"
                >
              ...
              {onCompleteProfile && (
                <button
                  ...
                  className="text-xs font-semibold text-gray-400 hover:text-[#38D5E3] underline underline-offset-2 transition-colors"
                >
            ...
            <>
              ...
              {onCompleteProfile && (
                <button
                  type="button"
                  onClick={onCompleteProfile}
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#38D5E3] text-[#0A0A0F] text-sm font-bold hover:bg-[#2bc3d1] transition-colors shadow-sm"
                >
