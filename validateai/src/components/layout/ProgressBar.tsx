              ...
              <div className="flex flex-col items-center gap-1.5 shrink-0">
                ...
                ${isCompleted
                    ...
                    : isActive
                      ...
                      : 'bg-gray-100 dark:bg-white/5 text-[#afaebb] border border-gray-200 dark:border-white/8'}
              `}>
                  {isCompleted ? (
                ...
                <span className={`text-[11px] font-medium whitespace-nowrap transition-colors ${displayCurrent >= (i + 1) ? 'text-gray-900 dark:text-[#F0EFF8]' : 'text-[#afaebb]'
                  }`}>
                  {step.label}
                </span>
              </div>
