...
export function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      else if (msg.toLowerCase().includes('user already registered')) { toast.error('Ya existe una cuenta con ese email. Inicia sesión.'); setIsSignUp(false); }
      else
    ...
    <div className="min-h-screen bg-[#F8F7FF] dark:bg-[#0A0A0F] flex">
      ...
      <div className="hidden lg:flex lg:w-[48%] bg-white dark:bg-[#12121A] border-r border-gray-100 dark:border-white/[0.06] relative overflow-hidden flex-col items-center justify-center p-12">
        ...
        <div className="relative z-10 text-center max-w-sm">
          ...
          <p className="text-gray-400 dark:text-[#afaebb] text-xs mt-2">— Founder en Santiago</p>
        </div>
      </div>
        ...
        <div className="flex-1 flex items-center justify-center px-4 pb-12">
          <div className="w-full max-w-sm">
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-xs text-gray-400 dark:text-[#afaebb] font-medium">o con email</span>
              <div className="flex-1 h-px bg-gray-200 dark:bg-white/[0.08]" />
            </div>
