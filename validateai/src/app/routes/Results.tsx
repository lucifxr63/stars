...
function ScoreBadge({ score }: { score: number | null }) {
  if (score == null) {
    return (
      <div className="w-14 h-14 rounded-2xl bg-gray-100 border-2 border-gray-200 flex flex-col items-center justify-center shrink-0">
  ...
  useEffect(() => {
    const fetch = async () => {
      const { data, error } = await supabase
        .from('validations')
        .select('id, idea_name, idea_industry, status, validation_score, current_step, created_at, completed_at, parent_id, version, pivot_reason')
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 max-w-3xl mx-auto w-full px-4 sm:px-6 py-8 md:py-12">
        ...
        <div className="flex items-start justify-between mb-8">
          <div>
            <h1 className="text-2xl font-black text-gray-900">Mis validaciones</h1>
        ...
        {!loading && validations.length === 0 && (
          <div className="text-center py-20">
            ...
            <h3 className="font-bold text-gray-900 mb-2">Todavía no has validado ninguna idea</h3>
        ...
        {!loading && (
          <div className="mt-12 bg-white rounded-2xl border border-gray-100 p-5 flex items-start gap-4 shadow-sm">
            ...
            <div className="flex-1">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h3 className="text-sm font-bold text-gray-900 mb-1">Mejora el ecosistema</h3>
      ...
      {pivotTarget && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-6">
            <h3 className="font-black text-gray-900 text-lg mb-1">Pivotar idea</h3>
            ...
            <textarea
              ...
              rows={3}
              className="w-full border border-gray-200 rounded-xl p-3 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-teal-400 mb-4"
            />
  ...
  return (
    <div
      ...
      className={`bg-white rounded-2xl border border-gray-100 p-4 sm:p-5 shadow-sm
                  hover:shadow-md hover:border-gray-200 transition-all duration-150 flex items-center gap-4
                  ${v.status === 'completed' ? 'cursor-pointer hover:bg-gray-50/50' : ''}`}
    >
